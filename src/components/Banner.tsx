...
const Banner = () => {
    ...
    return (
        <div className="mt-mixed transition-all duration-1000 relative flex flex-col justify-center items-center rounded-lg h-[150px] sm:h-[225px] bg-primary-500 shadow-lg custom-width gap-1.5 sm:gap-2">
